...
INSERT INTO asset VALUES ('id-1', 'test asset', 'asset-unique-2', 'projector', false, Now(), Now());

INSERT INTO booking VALUES ('id-1', 'user-id-1', 'asset-id-1', 4, 'user rating', 3, 'asset rating', 'booked', 'user-id-2', Now(), Now(), Now());
